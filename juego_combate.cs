...
class Enfrentamiento
{
    public void Iniciar (Gerrero guerrero1,Gerrero guerrero2)
    {
        ...
        Console.WriteLine(guerrero1.getplayer() + "ataca a "+ guerrero2.getplayer()+ " y le hace "+ guerrero1kd + "de daño");
        Console.WriteLine(guerrero2.getplayer() + "ataca a "+ guerrero1.getplayer()+ " y le hace "+ guerrero2kd + "de daño");
     ...
     if ( guerrero1.getVida() >= 0 && guerrero2.getVida()>= 0)
     {
        Console.WriteLine("solo un guerrro gano la pelea, pierde la pelea gotsilla");
     }
...
public class Program
{
    ...
    {
        Gerrero gerrero1 = new Gerrero("gotsilla", 100);
        Gerrero gerrero2 = new Gerrero("megalodon", 100);
